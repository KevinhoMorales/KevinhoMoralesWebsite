...
>(({ className, children, ...props }, ref) => (
  <AlertDialogPortal>
    <AlertDialogOverlay />
    {/*
      Centrado con translate en Content (Radix). Zoom/fade en un hijo: si van en el mismo nodo,
      tailwindcss-animate pisa el transform y el panel parece entrar desde un costado.
    */}
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'group fixed left-1/2 top-1/2 z-[101] w-full max-w-[min(24rem,calc(100%-1.5rem))] -translate-x-1/2 -translate-y-1/2 outline-none sm:max-w-lg'
      )}
      {...props}
    >
      <div
        className={cn(
          'grid gap-4 rounded-2xl border border-border/80 bg-card p-6 shadow-2xl',
